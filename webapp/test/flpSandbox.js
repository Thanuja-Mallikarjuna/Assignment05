		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "zcproduct_01",
									"targetURL": "#comibmzcproduct01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibmzcproduct01-display": {
								"semanticObject": "comibmzcproduct01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibm.zcproduct01",
									"url": sap.ui.require.toUrl("com/ibm/zcproduct01")
								}
							}
						}
					}
